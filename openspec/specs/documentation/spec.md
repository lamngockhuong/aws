...
Define standardized workflows for writing and translating AWS documentation, ensuring all documentation is up-to-date, accurate, and follows consistent quality standards. This capability requires AI assistants to use AWS MCP tools to fetch the latest official AWS documentation before writing or updating any documentation.
