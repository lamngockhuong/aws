...
1. **Always fetch latest AWS documentation first**: Before writing or updating any AWS service documentation, use `mcp_awslabs_aws-documentation-mcp-server_read_documentation` to fetch the latest official documentation from `docs.aws.amazon.com`
